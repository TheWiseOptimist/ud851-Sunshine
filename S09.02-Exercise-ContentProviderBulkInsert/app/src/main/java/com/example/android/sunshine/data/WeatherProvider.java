...
//  TODO completed (1) Implement the bulkInsert method
    ...
    public int bulkInsert(@NonNull Uri uri, @NonNull ContentValues[] values) {
        ...
        //  TODO completed (2) Only perform our implementation of bulkInsert if the URI matches the CODE_WEATHER code
        switch (sUriMatcher.match(uri)) {
            case CODE_WEATHER:
                ...
                //  TODO completed (3) Return the number of rows inserted from our implementation of bulkInsert
                if (rowsInserted > 0) {
                    getContext().getContentResolver().notifyChange(uri, null);
                }
                return rowsInserted;
            //  TODO completed (4) If the URI does match match CODE_WEATHER, return the super implementation of bulkInsert
            default:
