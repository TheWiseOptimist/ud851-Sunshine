...
public class WeatherDbHelper extends SQLiteOpenHelper {
    ...
    //  TODO completed (2) Increment the database version after altering the behavior of the table
    /*
    ...
    public void onCreate(SQLiteDatabase sqLiteDatabase) {
        ...
        final String SQL_CREATE_WEATHER_TABLE =
                ...
                "CREATE TABLE " + TABLE_NAME + " (" +
                        ...
                        // TODO completed (1) Append NOT NULL to each column's type declaration except for the _ID
                        // had already done this in prior exercise, then deleted to match lesson code :(
                        /*
    ...
    public void onUpgrade(SQLiteDatabase sqLiteDatabase, int oldVersion, int newVersion) {
        // TODO completed (3) Within onUpgrade, drop the weather table if it exists
        sqLiteDatabase.execSQL("DROP TABLE IF EXISTS " + TABLE_NAME);
        // TODO completed (4) call onCreate and pass in the SQLiteDatabase (passed in to onUpgrade)
