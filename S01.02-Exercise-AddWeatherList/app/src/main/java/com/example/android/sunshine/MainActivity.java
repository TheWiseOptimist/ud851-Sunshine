...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        String[] fakeWeatherData = new String[]{
                "Great Weather", "Great Weather", "Great Weather",
                "Fair Weather", "Fair Weather", "Fair Weather",
                "Poor Weather", "Poor Weather", "Poor Weather",
                "Terrible Weather", "Terrible Weather", "Terrible Weather"
        };

        // COMPLETED (4) Append each String from the fake weather data array to the TextView
        for (String fake : fakeWeatherData) {
            mTvWeatherData.append(fake + "\n\n\n");
        }
    }
}